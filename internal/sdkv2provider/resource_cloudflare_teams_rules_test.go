...
resource "cloudflare_teams_rule" "%[1]s" {
  ...
  rule_settings {
	...
	dns_resolvers {
		ipv4 = [
			{ ip = "1.34.4.4", port = 53, vnet_id = "5fb4dfe1-4fe7-4ff4-980e-72f89dd9af9e", route_through_private_network: true},
			{ ip = "1.34.4.5", port = 30000, vnet_id="", route_through_private_network = false},
			{ ip = "1.34.4.6", port = 200, vnet_id="", route_through_private_network = false}
		]
			
		ipv6 = [
			{ ip = "2a09:bac1:76c0:1378::b:248" , port = 53, vnet_id="", route_through_private_network: false},
			{ ip = "2a09:bac1:76c0:1378::b:148" , port = 53, vnet_id="", route_through_private_network: false}
		]
